 ...
 * @version 1.0
 */
public class PropertyClassloader implements IConfiguration {
	 ...
	 */
	public PropertyClassloader(String filePath) {
		super();
	...
	private void read() throws IOException {
		InputStream is = PropertyClassloader.class.getClassLoader().getResourceAsStream(filePath);
		properties.load(is);
		is.close();
	}
